<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('منصة تدبير المراسلات الإدارية') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 text-center">
                    {{ __("مرحبا بك على مستوى منصة تدبير المراسلات الإدارية ") }}
                </div>
                <div class="py-12 md:lg:xl:px-40   border-t border-b py-20 bg-opacity-10 sm:rounded-lg" >
        <div class="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-white shadow-xl shadow-neutral-100 border ">
            ...
            <div
                ...
                <p class="text-xl font-medium text-slate-700 mt-3">Expéditeurs</p>
                <p class="mt-2 text-sm text-slate-500">Gestion des expéditeurs</p>
            </div>
            ...
            <div
                ...
                <p class="text-xl font-medium text-slate-700 mt-3">courriers</p>
                <p class="mt-2 text-sm text-slate-500">Gestion des courriers</p>
            </div>
            ...
            <div class="p-10 flex flex-col items-center text-center group   md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
                ...
                <p class="text-xl font-medium text-slate-700 mt-3">-------------------</p>
